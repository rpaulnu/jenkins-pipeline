	...
	agent any 
		stages{
			stage('Login'){
				...
				steps{
						def loginRequest =   "curl -H 'Content-Type: application/x-www-form-urlencoded' -X POST -d username=user -d password=password https://eu1.anypoint.mulesoft.com/accounts/login".execute().text
